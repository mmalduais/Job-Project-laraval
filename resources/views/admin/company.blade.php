...
<div class="card mb-4">
  ...
  <form class="card-body" action="{{ route('add_company') }}" method="POST" enctype="multipart/form-data">
@csrf
  <div class="row g-3">
      <div class="col-md-6">
      ...
      <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">Descrition </label>
        <textarea name="description" class="form-label" id="" cols="30" rows="10"></textarea>
      </div>
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        <div class="form-password-toggle">
          <label class="form-label" for="multicol-confirm-password"> Is Active </label>
          <div class="input-group input-group-merge">
          <label class="switch">
