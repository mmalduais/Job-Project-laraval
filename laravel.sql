...
CREATE TABLE `elib_users` (
  ...
  `image` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'person.png',
...
--
-- إرجاع أو استيراد بيانات الجدول `elib_users`
--
...
CREATE TABLE `jobs` (
  ...
  `deatline` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
